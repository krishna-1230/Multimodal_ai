  ...
  return (
    <div className="relative flex min-h-[100svh] items-center justify-center px-6">
      ...
      <div className="card-glow glass w-full max-w-md rounded-2xl p-6 sm:p-8">
        <h1 className="neon-text text-center text-2xl font-bold text-electric-300">Welcome back</h1>
        <p className="mt-2 text-center text-slate-300/80">Sign in to continue</p>
          ...
          <div className="group">
            ...
            <input
              ...
              onPointerMove={(e) => {
                ...
                t.style.setProperty("--mouse-x", `${e.nativeEvent.offsetX}px`);
                t.style.setProperty("--mouse-y", `${e.nativeEvent.offsetY}px`);
              }}
        ...
        <p className="mt-6 text-center text-sm text-slate-400">
          No account? <Link className="text-electric-300 hover:underline" href="/signup">Create one</Link>
        </p>
      </div>
    </div>
  );
